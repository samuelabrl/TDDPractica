...
public class CasoInicialTest {
    ...
    public void caso4() throws IllegalPositionException {
        ...
        String resultado= Combate.combatir(uno, dos); //arg1: atacante, arg2: defenso
        String resultadoEsperado = "Carta uno (1501/2850/Posición: Ataque) vs Carta dos (2000/1500/Posición: Defensa) -> " +
    ...
    public void caso5() throws IllegalPositionException {
        ...
        String resultado= Combate.combatir(uno, dos); //arg1: atacante, arg2: defenso
        String resultadoEsperado = "Carta uno (2000/2850/Posición: Ataque) vs Carta dos (0/3000/Posición: Defensa) -> " +
    ...
    public void caso6() throws IllegalPositionException {
        ...
        String resultado= Combate.combatir(uno, dos); //arg1: atacante, arg2: defenso
        String resultadoEsperado = "Carta uno (1500/2850/Posición: Ataque) vs Carta dos (2000/1500/Posición: Defensa) -> " +
                "Empate.";
